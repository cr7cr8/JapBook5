...
import { StyleSheet, Button, Dimensions, TouchableOpacity, SafeAreaView, RefreshControl, Alert, Vibration, Keyboard, Pressable } from 'react-native';
...
export default function SettingScreen() {
    const { setSouceWordArr, saveWordToFile, sourceWordArr, refreshState, setRefreshState, wordPos, scrollX, scrollRef0,
        ...
        exportFileName, lightOrDarkstate, toggleLightOrDark
    } = useContext(Context)
                ...
                <View style={useAnimatedStyle(() => {
                    ...
                    <View style={{ width: screenWidth, height: 80, flexDirection: "row", alignItems: "flex-end", justifyContent: "space-around" }}>
                        ...
                        <Pressable onPressIn={() => {
                            ...
                            <Icon
                                name={wheat=="wheat"?"bulb":"bulb-outline"}  type='ionicon' color={orange}
                                containerStyle={{ width: 40, height: 40, transform: [{ rotateZ: "0deg" }, { translateX: 1 },{scale:1}] }}
                                size={40}
