...
export default function HomeScreen() {
    ...
    const { sourceWordArr, setSouceWordArr, scrollRef0, scrollRef, scrollRef2, frameTransY, wordPos, isListPlaying, preLeft, preTop, scrollY, scrollX, refreshState, setRefreshState,
        isPanning, speak, autoPlay, stopSpeak, isScrollingY, isScrollingX, isCardMoving, isManualDrag, shouldHideWordBlock, selectedLevelArr, isNewerstOnTop,
    ...
    const frameStyle1 = useAnimatedStyle(() => {
        return {
            ...
            backgroundColor: D6BD95,// "#D6BD95",//"darkgray",
    ...
    return (
        <View
            style={[{
                width: 2 * screenWidth, height: screenHeight, backgroundColor: D6BD95,//"#D6BD95",// "#eee", //"darkgray"
                opacity: 1,
            },
                            ...
                            <View style={[footStyle]}>
                                <Image source={require('./assets/kkll2.png')}
                                    ...
                                    style={{
                                        ...
                                        marginTop: 40, opacity: 0.6, transform: [{ scale: 1 }], borderRadius: 900
                                    }}
                                />
                            </View>
                        )
