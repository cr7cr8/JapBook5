...
export default function NewWordScreen() {
    ...
    const { speak, sourceWordArr, setSouceWordArr, saveWordToFile, isSaving, newWordText, setNewWordText, isNewerstOnTop, setRefreshState, totalWordsNum,
        ...
        <View style={[newWordPanelStyle]}>
            ...
            <View style={useAnimatedStyle(() => {
                ...
                <Input
                    ...
                    autoFocus={true}
                    value={newWordText}
                    inputStyle={{ fontSize: 23, color: wheat == "wheat" ? "#333" : "#ccc" }}
                    ...
                    inputContainerStyle={{
                        ...
                        paddingHorizontal: 0,
                        height: 60,
                        width: screenWidth - 8 - 8, borderWidth: 1, borderColor: "#555",// backgroundColor: "#e7cca0",// ,backgroundColor: "#aaa",
                        justifyContent: "flex-start", alignItems: "flex-start",
                        backgroundColor: isExist ? c3e1a2 : e7cca0,
                        paddingRight: 50,
                        borderBottomWidth: wheat=="wheat"?0: 1,
                ...
                >
                    {recmenWordsArr.map((item, index) => {
                        ...
                        return (
                            ...
                            <View style={{
                                width: screenWidth - 16, minHeight: 80,
                                borderWidth: 0,
                            ...
                            >
                                ...
                                >
                                    <View style={{
                                        ...
                                        minHeight: 80, borderLeftWidth: 1, borderRightWidth: 1, borderColor: "#555"
                                    }}>
                                        <Text style={{ fontSize: 15, fontWeight: 600, color: wheat == "wheat" ? "#333" : "#ccc" }}>{item.entry}</Text>
                                        <Text style={{ flex: 1, flexWrap: "wrap", fontSize: 15, color: wheat == "wheat" ? "#333" : "#ccc" }}>{item?.explain}</Text>
                                    </View>
                                </TouchableOpacity>
                                    ...
                                    onPress={function (e) {
                                        ...
                                        if (isExist) {
                                            ...
                                            const newWord = {
                                                ...
                                                "meaningSound": item.explain.replace(/【[^】]*】|（[^）]*）|\([^)]*\)/g, ''),  //item.explain.replace(/【[^】]*】/g, " ").trim() || "",
                                                "createTime": Date.now(),
                                                "toppingTime": Date.now(),
                                                "exampleEnglishArr": [],
                                                "exampleChineseArr": [],
